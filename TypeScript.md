...
构造一个对象类型，其键类型为 Keys，其属性值类型为 Type，此实用程序可用于将一种类型的属性映射到另一种类型。
...
通过从 UnionType联合类型中排除 ExcludedMembers 联合成员来构造类型。
...
通过从 Type 中提取所有可分配给 Union 的联合成员来构造一个类型，即从左边类型找出符合右边类型的构造新类型。
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/eXCSRjyNYcZc9K7EkrxF5ib2Kcw3g26xEGZb9jttIcPrmcPrPWXb8Ky94wergy8TUb9rsODKUEkZtdLxXFxxPyQ/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/eXCSRjyNYcZc9K7EkrxF5ib2Kcw3g26xEgk8iacicBdiceYKoPTWPIjQicgSquBkxVQvXVy18ZFWSn6O542lOSACCTQ/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/eXCSRjyNYcZc9K7EkrxF5ib2Kcw3g26xEM3QbYxdJhZjPWAWyt3Btd8Asp7muK45BicO4MkIJnCIjuPibB2vIST0Q/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/eXCSRjyNYcZc9K7EkrxF5ib2Kcw3g26xE0ibDM1u0uJnm5cfBJzwlODR5EGKnm0fQaDtticPncicAkBzCrOxYRsOYw/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)